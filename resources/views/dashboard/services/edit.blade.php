...
@section('main_title', 'Edit Service')
            ...
            <form action="{{ route('service.update', ['id' => $service->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <div class="mb-10">
                            ...
                            <input type="text" name="title" class="form-control form-control-solid @error('title') is-invalid @enderror" placeholder="Title Here" value="{{ $service->title }}">
                            @error('title')
                ...
                <div class="row">
                    <div class="form-check form-switch form-check-custom form-check-solid col-3">
                        <input class="form-check-input" type="checkbox" name="status" id="flexSwitchChecked" @if( $service->status == 1 ) checked="checked" @endif/>
                        <label class="form-check-label" for="flexSwitchChecked">
                            {{ 'Status' }}
                        </label>
                    </div>
                    <div class="image-input image-input-empty col-3" data-kt-image-input="true"
                         style="background-image: url({{ asset('storage') . '/' . $service->icon }}); margin: 15px; width: 10%; height: 10%;">
